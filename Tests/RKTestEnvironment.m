...
@interface RKTestCoverageLog : SenTestLog
@end
...
@implementation RKTestCoverageLog

+ (void)initialize
{
	[[NSUserDefaults standardUserDefaults] setValue:@"RKTestCoverageLog" forKey:SenTestObserverClassKey];
